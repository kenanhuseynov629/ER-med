    ...
    <section id="gallery" className="premium-section bg-gradient-to-b from-white to-slate-50">
      <div className="section-shell">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="relative aspect-[16/10] md:aspect-[21/10] rounded-3xl overflow-hidden shadow-2xl bg-slate-100">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="absolute left-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/80 backdrop-blur-sm hover:bg-white rounded-2xl flex items-center justify-center shadow-xl transition-all duration-300"
            ...
            <motion.button
              whileHover={{ scale: 1.15, backgroundColor: "rgba(255,255,255,0.95)" }}
              whileTap={{ scale: 0.9 }}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/80 backdrop-blur-sm hover:bg-white rounded-2xl flex items-center justify-center shadow-xl transition-all duration-300"
              onClick={handleNext}
            >
            ...
            <motion.button
              whileHover={{ scale: 1.15, backgroundColor: "rgba(255,255,255,0.95)" }}
              whileTap={{ scale: 0.9 }}
              className="absolute bottom-6 right-6 w-14 h-14 bg-white/80 backdrop-blur-sm hover:bg-white rounded-2xl flex items-center justify-center shadow-xl transition-all duration-300"
            ...
            {galleryImages.map((image, index) => (
              <motion.button
                ...
                className={`relative aspect-[16/9] w-28 md:w-40 rounded-2xl overflow-hidden border-2 transition-all duration-300 ${index === currentIndex
                  ...
                  : "border-transparent hover:border-gray-300 shadow-lg"
                  }`}
              >
                <Image
                  src={image.src}
